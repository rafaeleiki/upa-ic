...
const filterFAQByType = (filterType) =>
  data.filter(({ type }) => type === filterType)
...
const searchFaq = (query) =>
  data.filter(({ forQuery }) =>
    !!query ? forQuery.indexOf(query) >= 0 : false
  )
      ...
      <div className="container is-max-desktop mb-6">
        <div className="control has-icons-left has-icons-right">
          <input
            className="input"
            type="email"
            placeholder="Digite um pedaço da sua pergunta"
